...
void D3D12HelloTriangle::CreateShaderBindingTable()
{
	...
	// The helper treats both root parameter pointersand heap pointers as void*, 
	// while DX12 uses the D3D12_GPU_DESCRIPTOR_HANDLE to define heap pointers. The pointer in this 
...
void D3D12HelloTriangle::CreateCubeVB() {
	...
	Vertex cubeVertices[] = {
		{{-0.5f, -0.5f, -0.5f}, {0.0f, 0.8f, 0.9f, 1.0f}},
		{{0.5f, -0.5f, -0.5f},  {0.0f, 0.8f, 0.9f, 1.0f}},
		{{0.5f,  0.5f, -0.5f},  {0.0f, 0.8f, 0.9f, 1.0f}},
		{{0.5f,  0.5f, -0.5f},  {0.0f, 0.8f, 0.9f, 1.0f}},
		{{-0.5f,  0.5f, -0.5f}, {0.0f, 0.8f, 0.9f, 1.0f}},
